...
<div>
  <div class="w-100 ">
    ...
    <h1 class="mb-4 text-3xl font-extrabold  md:text-5xl lg:text-6xl text-center text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Roller replacement</h1>
    <div class="w-100 flex justify-center">
      <div class="w-100  pb-5 m-2 text-2xl text-black bg-purple-200 bg-opacity-50 rounded-xl flex  justify-center">
        <div class="  container ">
          <p>When rollers begin to wear, loosen, or bend, they can cause your garage door to open and close more slowly
            or in a jerky manner. This puts more strain on the garage door opener system, which ultimately decreases its lifespan.</p>
