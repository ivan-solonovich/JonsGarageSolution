...
<template>
  ...
  <nav class="w-100 bg-gray-50 grid grid-cols-1 lg:grid-cols-3 justify-items-center">
    <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
      <RouterLink :to="{name:'home'}" active-class="none" class="navigate">
      <a href="#" class="flex items-center">

        <img src="../../../public/johns-line.png" class="h-24 mr-3" alt="JonsGarageSolution Logo" />
<!--        <span class="self-center lg:text-2xl sm:text-sm font-semibold whitespace-nowrap text-black dark:text-white">John’s garage door repair</span>-->
    ...
    <div class="callMe p-4 w-100 text-center">
      <a  class="phone pl-2" href="tel:+18183177803">
        <button  class="bg-primary hover:bg-gray-400 rounded-[.5rem] text-secondary pr-2  py-2 px-4 rounded inline-flex items-center">
      ...
      <div  class="mainMenu lg:block sm:hidden">
        <ul   class="flex justify-between font-medium quicksand p-2 md:p-0 mt-4 border border-gray-100  bg-gray-50 ">
          <li>
            <RouterLink :to="{name:'home'}" active-class="none" class="navigate">
              <a href="#" class="block quicksand py-2 pl-3 pr-4 text-primary  rounded md:bg-transparent  md:p-0 " aria-current="page">Home</a>
            </RouterLink>
          </li>
          <li>
        ...
        <div v-show="isMobile" id="mobileMenuButton" class="lg:hidden">
          <button @click="changeMenu"   type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg  hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" >
            <span class="sr-only">Open main menu</span>
            <svg class="w-5 h-5 stroke-secondary" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 17 14">
